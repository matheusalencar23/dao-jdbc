...
public class Program {
	...
	public static void main(String[] args) {
		SellerDao sellerDao = DaoFactory.createSellerDao();
		  ...
		  sellerDao.findByDeparment(department); for (Seller obj : list) {
		  ...
		  Seller newSeller = new Seller(null, "Greg Blue", "greg@gmail.com", new Date(), 4000.0, department); sellerDao.insert(newSeller);
		  System.out.println("Seller inserted! New id = " + newSeller.getId());
		 
		  System.out.println("\n=== TEST #5: Seller - update === "); 
		  seller = sellerDao.findById(8);
		  seller.setName("Max Yellow");
		  seller.setEmail("max@gmail.com");
